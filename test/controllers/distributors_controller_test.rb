...
class DistributorsControllerTest < ActionController::TestCase
  ...
  test "should create distributor" do
    assert_difference('Distributor.count') do
      post :create, distributor: { address: @distributor.address, city: @distributor.city, contact: @distributor.contact, email: @distributor.email, name: @distributor.name, state: @distributor.state }
    end
  ...
  test "should update distributor" do
    patch :update, id: @distributor, distributor: { address: @distributor.address, city: @distributor.city, contact: @distributor.contact, email: @distributor.email, name: @distributor.name, state: @distributor.state }
    assert_redirected_to distributor_path(assigns(:distributor))
  end
